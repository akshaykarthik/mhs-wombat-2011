...
public class GameServerThread extends Thread
	{
		...
		public void run(){
			try{
				...
				InetAddress group = InetAddress.getByName("203.0.113.0");  //Users would join this group in the client program
				DatagramPacket packet = new DatagramPacket(buf, buf.length, group, 27001);  //Sends to everyone in the InetAddress group
				socket.send(packet);
			} 
